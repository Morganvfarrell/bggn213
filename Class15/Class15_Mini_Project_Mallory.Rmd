...
# Now we are joining multiple tables from the CMI-PD database
...
# Examining the IgG1 Ab titer levels
...
It does slightly, I thought that some of the antigens peaked at visit 5 from the antibody data but that is very close to the expression levels peaking at visit 4.  Additionally, antibodies will persist in the system for a long time and the cells will continue to make them. This explains why the antibody levels stay high in visits 5-7. 
